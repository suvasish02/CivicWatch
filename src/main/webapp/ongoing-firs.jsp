...
<head>
    ...
    <title>Ongoing FIRs - Civic Watch</title>
...
<body>
    ...
    <div class="container firs-container">
	    	...
	    	try{
	            ...
	            String q="SELECT fd.* from fir fd join fir_status fs ON fd.firno=fs.fir_id where fs.status ='Pending' or fs.status='Ongoing'";
            ...
            <div class="action-buttons">
                <button class="btn btn-success btn-sm" type="submit">Mark as Solved</button>
            </div>
            </form>
        </div>
    ...
    <script>
        // Example function to mark FIR as Solved
        function markAsSolved(firId) {
            console.log('Marking FIR as solved:', firId);
            // Implement AJAX call or other method to update FIR status in the database
            alert('FIR #' + firId + ' marked as solved.');
        }
    </script>
</body>
</html>

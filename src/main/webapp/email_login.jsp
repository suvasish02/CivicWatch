...
<body>
    <header class="header">
        <img src="./assets/images/logo.png" alt="Civic Watch Logo" class="logo" href="index.html"> <!-- Ensure the image path is accessible -->
    </header>
    <div class="login-container">
        <h2>Login with Email</h2>
        <form action="./emaillogin" method="POST"> <!-- Specify the action URL -->
            ...
            <div class="form-group">
				...
				<a href="./getMail.jsp" class="btn" type="submit">Forgot Password?</a>            
